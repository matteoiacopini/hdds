#' Creates a circular sector, starting from the II quadrant and ending in the I quadrant,
...
#'
#' @examples
#' circleFun_up(diameter = 1.0)
#'
#' @return matrix object with values relating to the color shading
#'
#' @export

circleFun_up = function(center=c(0,0.02), diameter, npoints=100, start=0, end=2, filled=TRUE){
